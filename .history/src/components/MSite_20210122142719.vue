  ...
  <div class="msite">
    ...
    <div class="shops_lists">
      ...
      <van-card thumb="https://img.yzcdn.cn/vant/ipad.jpeg">
        <template #title>
          <van-tag color="#FFD857" text-color="black" size="medium" style="font-weight:700">品牌</van-tag>
          <b class="shops_title">嘉禾一品(温都水城)</b>
        </template>
        <template #tags>
          <div style="margin-top:18px;">
              <van-rate v-model="value" allow-half color="#FF992D" readonly size="14" />
              <span>4.7</span>
              <span>月售755单</span>
          </div>
        </template>
              ...
              init(o) {
                ...
                o.getCurrentPosition((status, result) => {
                  ...
                  if (result && result.position) {
                    ...
                    var index = result.formattedAddress.indexOf(result.addressComponent.township)
                   self.positionAddress =  result.formattedAddress.substring(index+len);
